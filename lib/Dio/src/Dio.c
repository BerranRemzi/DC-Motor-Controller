...
void Dio_Init(void)
{
    ...
    Dio_ChannelDirectionSet(BUTTON_UP, INPUT_PULLUP);
    Dio_ChannelDirectionSet(BUTTON_DOWN, INPUT_PULLUP);
    Dio_ChannelDirectionSet(BUTTON_RIGHT, INPUT_PULLUP);
    Dio_ChannelDirectionSet(BUTTON_LEFT, INPUT_PULLUP);
    Dio_ChannelDirectionSet(SOFTSPI_CLK, OUTPUT);
    Dio_ChannelDirectionSet(SOFTSPI_MOSI, OUTPUT);
    Dio_ChannelDirectionSet(SOFTSPI_CS, OUTPUT);
    Dio_ChannelDirectionSet(BUTTON_STOP, INPUT_PULLUP);
